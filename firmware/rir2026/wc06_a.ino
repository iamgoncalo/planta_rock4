 ...
 *  ETIQUETA: WC-06_U_A
 * ============================================================================
 *  Cluster:  wc-06   (cluster_id no POST)
 *  Seccao:   u        ("m" | "f" | "u")
 *  Porta:            ("LL" | "LR" | "C" | "")
 *  USAR_IR:  false      (true = LLH/LRH/LLW/LRW; false = LC/unissexo)
 *  Cap:      208
 *  Coord:    38.78219 / -9.093601
 * ============================================================================
...
// ── Identidade ────────────────────────────────────────────────────────────────
const char* CLUSTER_ID = "wc-06";
const char* NOME_CURTO = "WC-06 UNI A";
const char* PORTA_ID   = "";    // "LL", "LR", "C", ""
const char* SECAO_ID   = "u";   // "m", "f", "u"
int         CAPACIDADE = 208;
float       LAT        = 38.78219;
float       LON        = -9.093601;
